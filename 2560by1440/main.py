...
bar_region_mss = {'top': barregion.top, 'left': barregion.left, 'width': barregion.width, 'height': barregion.height-160}
print(barregion.height)
...
limit = 12  #how many rounds we want
success = 0 #how many times we hit the cyanblock
    ...
    try:
        while True:
            ...
            if is_round_active:
                ...
                time.sleep(1)  # wait 1s before starting next round 
